...
export function ProductCard({ product }: { product: any }) {
  ...
  return (
    <div
      className="relative w-full group mb-8 cursor-pointer"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* 1. ANA KART KAPSAYICISI: 'overflow-hidden' burada, animasyon taşmalarını kesin engeller */}
      <div className="relative rounded-[2rem] bg-[#121214] border border-white/5 overflow-hidden transition-all duration-300 hover:border-emerald-500/30 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)]">
        ...
        {/* 2. AI MATCH ROZETİ: Kapsayıcının İÇİNDE, sol üst köşeye pürüzsüz oturtuldu */}
        ...
        {/* 3. RESİM VE HOVER (Açıklama) ALANI */}
        <div className="relative h-72 w-full bg-[#1a1a1c] overflow-hidden">
          <img
        ...
        <div className="p-6 relative z-30 bg-[#121214]">
          <p className="text-[10px] text-emerald-500 font-bold uppercase tracking-widest mb-2">
            {product.brand || "GENEL MARKALAR"}
          </p>
          <h3 className="text-white font-semibold text-lg leading-tight mb-6 line-clamp-2">
            {product.name}
          </h3>
